 ...
 */
export function PosterBackdrop({ subtle = false }: { subtle?: boolean }) {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(closest-side at 31% 34%, rgba(0, 55, 255, 0.46), rgba(0, 55, 255, 0) 62%)",
          }}
        />
        <div
          className="absolute inset-0"
          style={{
            background:
              "radial-gradient(closest-side at 68% 64%, rgba(0, 55, 255, 0.24), rgba(0, 55, 255, 0) 55%)",
          }}
        />
        <div
          className="absolute inset-0"
          style={{
            background:
              "conic-gradient(from 60deg at 52% 48%, rgba(250, 247, 234, 0) 0deg, rgba(14, 14, 12, 0.09) 110deg, rgba(250, 247, 234, 0) 200deg, rgba(0, 55, 255, 0.14) 290deg, rgba(250, 247, 234, 0) 360deg)",
          }}
        />
      </div>
