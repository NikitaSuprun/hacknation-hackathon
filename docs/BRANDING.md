...
**Don't:** pure `#FFF`/`#000` · gray panel backgrounds · electric on ink (use `--electric-on-ink`) · accent hovers on non-primary elements · animate layout properties · more than one swirl per page · "apply/submit" anywhere a founder can read · emoji in UI · WebGL inside the investor instrument.
