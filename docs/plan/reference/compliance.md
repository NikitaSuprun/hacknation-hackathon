...
4. Bronze: delete `github_users_raw`; delete/redact `github_commits_raw` by author id / erased emails; artifact rows (repos/papers/companies) remain minus the deleted relationship rows.
